      ...
      <FormContext>
        ...
        <main className="grid grid-cols-[1fr_25%] h-screen">
          ...
          <div className="bg-white shadow p-8 text-black">
            ...
            <textarea placeholder="Enter form page JSON here..." className="w-full shadow-inner rounded-md mt-8 p-2 px-3 h-32 outline-none border border-zinc-400 resize-none text-black placeholder:italic placeholder:text-zinc-400 focus-within:border-zinc-800 focus-within:ring-4 ring-nex-green" />
            <button className="rounded-md px-4 py-1 bg-sync-200 float-right">Copy</button>
          </div>
        </main>
      </FormContext>
    </div>
